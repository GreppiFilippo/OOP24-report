...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{img/ObjExtractor.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{img/CollisionDetector.png}
    \label{img:ObjectExtractor}
\end{figure}
...
\begin{itemize}
	\item DoorImpl
	\item InteractableFactory
	\item AbstractDoorDecorator
\end{itemize}
...
%
\begin{itemize}
	\item % qui vanno inseriti i permalink
\end{itemize}
%
\subsection{Filippo Greppi}
%
